...
public class GastronomyAdapter extends RecyclerView.Adapter<GastronomyAdapter.ViewHolder>{

    private ArrayList<Gastronomy> gastronomies;
    Context context;
    ...
    public GastronomyAdapter(Context context, ArrayList<Gastronomy> gastronomies) {
    ...
    @Override
    public GastronomyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        textViewTitle.setText(gastronomies.get(position).getName());
        textViewContent.setText(gastronomies.get(position).getDescription());
