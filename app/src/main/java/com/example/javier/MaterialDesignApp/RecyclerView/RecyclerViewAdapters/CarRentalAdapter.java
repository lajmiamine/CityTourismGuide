...
public class CarRentalAdapter extends RecyclerView.Adapter<CarRentalAdapter.ViewHolder>{
    ...
    private ArrayList<CarRental> carrenatls;
    Context context;
    ...
    public CarRentalAdapter(Context context, ArrayList<CarRental> carrenatls) {
        this.carrenatls = carrenatls;
        this.context = context;
    }

    // Create new views. This is invoked by the layout manager.
    @Override
    public CarRentalAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        textViewTitle.setText(carrenatls.get(position).getName());
        textViewContent.setText(carrenatls.get(position).getWebsite());
