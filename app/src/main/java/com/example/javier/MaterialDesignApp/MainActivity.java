...
public class MainActivity extends ActionBarActivity {
    ...
    public String[] listGroupe = { "Lajmi Mohamed Amin","Hamza Khribi","Amal Harbaoui" };
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_emergency) {
            ...
            Intent myIntent = new Intent(MainActivity.this, emergency_calls.class);
    ...
    public void onBackPressed() {
        ...
        Toast.makeText(this, "Get back soon", Toast.LENGTH_SHORT).show();
